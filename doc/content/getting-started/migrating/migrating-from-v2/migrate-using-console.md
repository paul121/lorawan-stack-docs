...
{{< note >}} This method comes down to adding end devices in {{% tts %}} Console one by one, and it is not possible to migrate groups of devices as with using `ttn-lw-migrate` tool. {{</ note >}}
